...
class AdyaMotaScreen extends StatelessWidget {
  const AdyaMotaScreen({Key? key}) : super(key: key);
            ...
            body: Container(
              ...
              child: Padding(
                ...
                child: ListView.separated(
                            ...
                            if (AppCubit.get(context)
                              ...
                              Container(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(19.0),
                                  child: Text(
                                    "- ${AppCubit.get(context).adyamotaModel[index].bless??""}",
                                    style: TextStyle(
                                        fontWeight: FontWeight.w500,
                                        fontFamily: "MyFont",
                                        fontSize: 20,
                  ...
                  itemCount: AppCubit.get(context).adyamotaModel.length,
                ),
              ),
            ),
          ),
